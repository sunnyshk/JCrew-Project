...
function Home() {
  return (
    <div className="Container">
      ...
      <GridImgs>
        <img src="https://i.imgur.com/UOyynVr.png" alt="" />
        <img src="https://i.imgur.com/xAzmy35.png" alt="" />
        <img src="https://i.imgur.com/8bmoaGT.png" alt="" />
        <img src="https://i.imgur.com/M2HrlpX.png" alt="" />
        <img src="https://i.imgur.com/veCZHyk.png" alt="" />
        <img src="https://i.imgur.com/Fy4Q4Qb.png" alt="" />
      </GridImgs>
      <Buttons>
      ...
      <PinkDiv>
        ...
        <div className="d-mid">
          <div className="d-card">
            ...
            />
            <p>1 piece, 2 ways</p>
            <h1>How I wear my Astrid chinos with Jen</h1>
            <button>Copy these outfits</button>
          </div>
          <div className="d-card">
            <img
            ...
            <h1>The new dress code with Beverly Nguyen</h1>
            <button>Find her everyday picks</button>
          </div>
          <div className="d-card">
            <img
            ...
            <h1>Instant classics with Allison Bornstein</h1>
            <button>Shop her timeless style</button>
          </div>
        </div>
