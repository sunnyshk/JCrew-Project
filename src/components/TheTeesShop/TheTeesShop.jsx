...
export const TheTeesShop = () => {
  const [bed, setbed] = useState([]);

  useEffect(() => {
    async function getData() {
      const data = await fetch("https://ancient-dawn-26797.herokuapp.com/the_tees_shop?_limit=12").then(
        (d) => d.json()
      );
      setbed(data);
    }
  ...
  return (  
    <div>
      ...
      <div id="div-6">
        {bed.map(e=>{
            return <Link to={`/TheTeesShop/${e.id}/the_tees_shop`} id="card-1">
            <div id="img-1" >
