...
export const BrandWelove = () => {
  const [bed, setbed] = useState([]);

  useEffect(() => {
    async function getData() {
      const data = await fetch("https://ancient-dawn-26797.herokuapp.com/brands_welove?_limit=12").then(
        (d) => d.json()
      );
      setbed(data);
    }
  ...
  return (
    <div>
      ...
      <div id="top2">
        <h1 id="top-text2">Brands We Love</h1>
      </div>
      <div id="top3">
        <select name="" id="">
      ...
      <div id="div-6">
        {bed.map(e=>{
            return <Link to={`/BrandWelove/${e.id}/brands_welove`} id="card-1">
            <div id="img-1" >
