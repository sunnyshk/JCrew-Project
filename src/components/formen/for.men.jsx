...
export const Formen = () => {
  ...
  useEffect(() => {
    async function getData() {
      const data = await fetch("https://ancient-dawn-26797.herokuapp.com/formen?_limit=12").then((d) =>
        d.json()
      );
      setformen(data);
    }
  ...
  return (
    <div className="for">
      ...
      <div id="div-6">
        {formen.map((e) => {
          return (
            <Link to={`/Formen/${e.id}/formen`} id="card-1">
              <div id="img-1">
...
// {formen.map(e =>
// <Link to={`/Formen/${e.id}/formen`} className="mybox">
