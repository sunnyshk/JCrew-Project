...
export const GirlstopsTees = () => {
  const [saleboy, setsale] = useState([]);

  useEffect(() => {
    async function getData() {
      const data = await fetch("https://ancient-dawn-26797.herokuapp.com/GIRLSTOPS&TEES?_limit=12").then((d) =>
        d.json()
      );
      setsale(data);
    }
  ...
  return (
    <div className="for">
      ...
      <div id="top2">
        <h1 id="top-text2">Girl's Top And Tees</h1>
      </div>
      <div id="top3">
        <select name="" id="">
      ...
      <div id="div-6">
        {saleboy.map((e) => {
          return (
            <Link to={`/GirlstopsTees/${e.id}/GIRLSTOPS&TEES`} id="card-1">
              <div id="img-1">
