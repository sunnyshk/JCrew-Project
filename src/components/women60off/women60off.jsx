...
// import "./women60off.css"
import { Link } from "react-router-dom";

export const Women60off = () => {
  const [forwo, setwo] = useState([]);
  ...
  return (
    <div className="for">
      ...
      <div id="div-6">
        {forwo.map((e) => {
          return (
            <Link to={`/Women60off/${e.id}/women60off`} id="card-1">
              <div id="img-1">
...
// {forwo.map(e =>
// <Link to={`/Women60off/${e.id}/women60off`} className="mybox">
