...
export const Graphicsshop = () => {
  const [shop, setshop] = useState([]);

  useEffect(() => {
    async function getData() {
      const data = await fetch("https://ancient-dawn-26797.herokuapp.com/graphicsshop?_limit=12").then((d) =>
        d.json()
      );
      setshop(data);
    }
  ...
  return (
    <div className="for">
      ...
      <div id="div-6">
        {shop.map((e) => {
          return (
            <Link to={`/Graphicsshop/${e.id}/graphicsshop`} id="card-1">
              <div id="img-1">
