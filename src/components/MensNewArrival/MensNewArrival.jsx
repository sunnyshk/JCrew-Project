...
export const MensNewArrival = () => {
  const [bed, setbed] = useState([]);

  useEffect(() => {
    async function getData() {
      const data = await fetch("https://ancient-dawn-26797.herokuapp.com/mens_new_arrival?_limit=12").then(
        (d) => d.json()
      );
      setbed(data);
    }
  ...
  return (
    <div>
      ...
      <div id="top2">
        <h1 id="top-text2">MEN'S NEW ARRIVALS</h1>
      </div>
      <div id="top3">
        <select name="" id="">
      ...
      <div id="div-6">
        {bed.map(e=>{
            return <Link to={`/MensNewArrival/${e.id}/mens_new_arrival`} id="card-1">
            <div id="img-1" >
