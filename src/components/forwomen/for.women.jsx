...
export const Forwomen = () => {
  ...
  useEffect(() => {
    async function getData() {
      const data = await fetch("https://ancient-dawn-26797.herokuapp.com/forwomen?_limit=12").then((d) =>
        d.json()
      );
      setforwomen(data);
    }
  ...
  return (
    <div className="for">
      ...
      <div id="div-6">
        {forwomen.map((e) => {
          return (
            <Link to={`/Forwomen/${e.id}/forwomen`} id="card-1">
              <div id="img-1">
...
// {forwomen.map(e =>
// <Link to={`/Forwomen/${e.id}/forwomen`} className="mybox">
